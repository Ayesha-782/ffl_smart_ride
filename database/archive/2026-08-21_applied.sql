...
-- Ensure driver_availability has seats_offered and seats_remaining
ALTER TABLE public.driver_availability
    ADD COLUMN IF NOT EXISTS seats_offered INT NOT NULL DEFAULT 3,
    ADD COLUMN IF NOT EXISTS seats_remaining INT NOT NULL DEFAULT 3;

-- Ensure ride_matches has confirmation_deadline
ALTER TABLE public.ride_matches
    ADD COLUMN IF NOT EXISTS confirmation_deadline TIMESTAMP WITH TIME ZONE;

-- Ensure ride_completion_log has liters_fuel_saved
